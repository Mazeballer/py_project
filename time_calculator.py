   ...
   #------------------------------------------------------------------------------------------ 
    if day_night[0] == "AM" :
        ...
        if orisum_hour == 12:                                                      # for (hours = 12) 
            ...
            circadian_rhythm1 = int(orisum_hour/ 12)        # to decide which the day is(calculate pass how many 12 hours)
        ...
        if day == None:
            if count_day:
                the_day = f"{hour}:{str(minute).zfill(2)} {daynight}, ({count_day})"
            else:
                the_day = f"{hour}:{str(minute).zfill(2)} {daynight}"
        else:
            if count_day:
...
print(add_time("3:30 PM", "48:12","Monday"))
